...
import {getIngredient, patchIngredient} from '../../../../http/ingredientsAPI'
import {observer} from 'mobx-react-lite'

const EditIngredients = observer(() => {
    ...
    const sendIngredient = async () => {
        try {
            await patchIngredient(id, {title: title})
            ...
            <section className="bg-white h-screen pt-10 dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <div className="mx-auto max-w-screen-sm">
                        ...
                        <p className="mb-8 font-light text-gray-500 lg:mb-16 sm:text-xl dark:text-gray-400">Здесь можно отредактировать ингредиент</p>
                    </div>
                    <form action="#">

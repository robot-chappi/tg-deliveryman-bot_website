...
const Payment = () => {
    ...
    if (loading) {
        return <div>
            ...
            <section
              style={{height: '65vh'}}
              className="block p-6 pt-10 w-full bg-white transition-transform dark:bg-gray-800">
                <h1
                  className="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">У вас нету активных заказов</h1>
                <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Вы можете создать свой заказ по кнопке ниже, а затем оплатить его тут</p>

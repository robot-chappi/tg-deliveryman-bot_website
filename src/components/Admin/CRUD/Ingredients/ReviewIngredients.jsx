...
import {getIngredient} from '../../../../http/ingredientsAPI'
import {observer} from 'mobx-react-lite'

const ReviewIngredients = observer(() => {
    const {id} = useParams();
            ...
            <div className="overflow-x-auto h-screen pt-10">
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tr className="border-b dark:border-gray-700">
                        ...
                        <td className='px-4 py-3 text-gray-800 dark:text-white'>{ingredient.id}</td>
                    </tr>
                    <tr className="border-b dark:border-gray-700">
                        <th className='px-4 py-3'>Название</th>
                        <td className='px-4 py-3 text-gray-800 dark:text-white'>{ingredient.title}</td>
                    </tr>
                    </tbody>
                </table>

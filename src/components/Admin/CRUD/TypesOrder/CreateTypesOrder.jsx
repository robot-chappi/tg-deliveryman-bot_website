...
import {createTypeOrder} from '../../../../http/typeOrderAPI'

const CreateTypesOrder = () => {
    ...
    const sendTypeOrder = async () => {
        try {
            await createTypeOrder({title: title, slug: slug})

            return navigate('/admin/typeorders')
        } catch (e) {
            console.log(e);
        }
    }
            ...
            <section className="bg-white h-screen pt-10 dark:bg-gray-900">
                <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    <div className="mx-auto max-w-screen-sm">
                        <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Создание типа заказа</h2>
...
export default CreateTypesOrder;